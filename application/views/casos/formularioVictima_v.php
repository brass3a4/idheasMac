				...
				<fieldset>
					<legend>Información general</legend>
						...
						<div class="twelve columns"> 
							...
							<?= (!empty($victimas['victimas']) && (isset($victimas['victimas'][$idVictima]['estatusVictimaId']))&&($victimas['victimas'][$idVictima]['estatusVictimaId']>0)) ? $catalogos['estatusVictimaCatalogo'][$victimas['victimas'][$idVictima]['estatusVictimaId']]['descripcion'] : "" ;?><br />
						</div>
							...
							<div class="twelve columns espacio">
								<br/><label>Perpetradores</label> <br/>
						            ...
						            <table class="twelve columns">
						                ...
						                <tbody>
											<?php if (!empty($victimas['victimas'])&&isset($victimas['victimas'][$idVictima]['perpetradores'])) { ?>
